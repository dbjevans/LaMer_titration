function [DATA,HEADERS,NICEHEADERS]=...
    CO2SYSpalaeo(PAR1,PAR2,PAR1TYPE,PAR2TYPE,SAL,TEMPIN,TEMPOUT,PRESIN,PRESOUT,...
    SI,PO4,pHSCALEIN,K1K2CONSTANTS,KSO4CONSTANTS,K1palaeo,K2palaeo)
%**************************************************************************
%
...
%    CO2 System Calcula2400,8.1,tions. ORNL/CDIAC-105. Carbon Dioxide Information
...
function Constants(TempC,Pdbar)   % add K1 palaeo as inputs here
